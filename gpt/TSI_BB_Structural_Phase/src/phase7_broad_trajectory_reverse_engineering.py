...
def main(indir,outdir):
    ...
    summary={"method":"Direct 48h 15m pre-entry trajectory reverse engineering from r2 winners vs losers; nearest trajectory search on a broader TSI/BB neighborhood outside r2",
    ...
    (outdir/"REPORT.md").write_text("# Phase 7 Broad-Neighborhood Trajectory Reverse Engineering\n\n"+json.dumps(summary,indent=2,ensure_ascii=False),encoding="utf-8")
