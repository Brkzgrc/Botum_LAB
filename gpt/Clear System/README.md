...
Market Breadth veri preflight'ı geçti. Tam araştırma, tam dönem breadth context'ini tek job'da üretip artifact olarak shard'lara dağıtacak; her shard referans verisini yeniden indirmeyecek. Hipotez yalnız ortak breadth daralma→genişleme hareketinden sonra oluşan coin-bazlı kapalı-mum yapı kırılımını değerlendirecek. Seçim Discovery + Calibration + pre-2026 cross-holdout kapılarıyla yapılacak; 2026 yalnız dondurulmuş aday için açılacak. Tahmini bütçe 350–430 runner-dk / 45–55 dk; timeout ve eksik-shard korumaları geçmeden run başlatılmayacak.
