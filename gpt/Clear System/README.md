...
Trade-intensity/ortalama işlem büyüklüğü ailesi elendi; aynı eşik taraması yeni adla tekrarlanmayacak. Sıradaki yapısal olarak farklı hipotez **Market Breadth Ignition**: BTC/ETH/BNB/SOL/XRP/DOGE kapalı 15M→1H hareketlerinden piyasa katılımının daralma→genişleme geçişini üretip, yalnız bu ortak hareket başladıktan sonra coin bazlı yapısal tetik aramak. Önce yalnız altı referans sembolde kısa veri/schema preflight yapılacak; tahmini 5–12 runner-dk, üst duvar süresi 22 dk. Veri kapsaması, kapanmış-mum hizası ve yeterli breadth-transition olayı geçmeden pahalı tam tarama başlatılmayacak. Aday oluşursa Discovery + Calibration + pre-2026 cross-holdout, ardından 2026 ve frozen r2 OR doğrulaması zorunlu.
