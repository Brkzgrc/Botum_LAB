...
Taker-flow emilim/serbestleşme ailesi elendi; aynı taker-share eşikleri yeni adla tekrarlanmayacak. Sıradaki bağımsız veri ailesi, Binance kline içindeki işlem sayısı (`trades`) ve mum başına ortalama işlem büyüklüğünün kapanmış 15M→1H→4H dizileridir. Hipotez: fiyat henüz sınırlıyken işlem yoğunluğu/ortalama büyüklük genişlemesi ve ardından yapı kırılımı. Önce yerel compile, self-test, nedensellik/evren ve gerçek-veri smoke kapıları hazırlanacak. Önceki run gerçekleşen bütçesi referans alınarak yeni tam çalışma yaklaşık 340–390 runner-dk ve 30–35 dk duvar süresi olarak sınırlandırılacak. Aday çıkarsa önce 2026 OOS, sonra frozen r2 dedupe/OR doğrulaması yapılacak.
